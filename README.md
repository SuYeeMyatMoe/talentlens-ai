...
## 🏗️ System and User Flow

```
╔══════════════════════════════════════════════════════════════════════════╗
║                     TALENTLENS AI  —  COMPLETE FLOW                     ║
╚══════════════════════════════════════════════════════════════════════════╝

  👤 CANDIDATE                  💼 RECRUITER              ⛓ POLYGON
  ────────────                  ────────────              ─────────
  ...
  (name + email only)
         │
         ▼
  Browse Jobs ◄──────────── Create Job Posting
         │                  (or ✨ AI Generator)
         ▼
  Upload Resume
  PDF or DOCX
  ...
  until AI triggered ─────────────────────────────►
                                         ...
                                         ║          384-dim skill vectors  ║
                                         ║          Cosine similarity      ║
                                         ║               │                 ║
                                         ║  STEP 3  5-Factor Scoring       ║
                                         ║          Skills      40%        ║
                                         ║          Experience  25%        ║
                                         ║          Projects    20%        ║
                                         ║          Diversity   10%        ║
                                         ...
                                         ╚════════════════╤════════════════╝
                                                          │
  Resume LOCKED ◄──────────────────────────── Notify: "Analysis complete"
         │
         ...
         │                   = resumeHash
         │                                  │
         │                   logHiringDecision() ──────────► TX Hash written
         │                                                    Permanent record
         │                                                    Cannot be deleted
         ◄── Notification: "Decision made — view your AI report"
         │
         ▼
...
╠══════════════════════════╦═════════════════════════════╣
║  Database (MySQL/SQLite) ║ Full scores, explanation,   ║
║                          ║ bias report, notifications  ║
╠══════════════════════════╬═════════════════════════════╣
║  Polygon Blockchain      ║ resumeHash + score +        ║
║                          ║ fairness + decision +       ║
